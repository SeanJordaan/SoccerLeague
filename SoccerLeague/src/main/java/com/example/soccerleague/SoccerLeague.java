...
public class SoccerLeague {
    ...
    public static void main(String[] args) {
        ...
        String succes = checkGames(in, scoreBoard);//Check games returns a string or null
                                                    //it takes two perameters the in and the scoreboard
        while (succes != null) {
    ...
    private static String checkGames(BufferedReader in, HashMap<String, Integer> scoreBoard) {
        String line;
        String[] game; //splitting the two teams at the comma
        String[] team1score1;//team 1 score 1 and renaming x
        String[] team2score2;
        String team1;
        int score1;
        String team2;
        ...
        if (line == null || line.equals(""))
            ...
            if (score1 > score2) {
                ...
                if (scoreBoard.containsKey(team1)) { //Key is the team name
                    scoreBoard.put(team1, scoreBoard.get(team1) + 3);//so if the team is there add 3 points
                } else {
                    scoreBoard.put(team1, 3);// if the team isnt there then it puts 3 points on
                }
